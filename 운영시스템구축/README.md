...
### 배경
- e-Navagation 이란 해양 선박 네비게이션 관련 국가 산업 입니다.
담당했던 서비스는 해양 단말과 육상 서비스 간 메시지를 변환 및 전달 하는 서비스를 담당 하였습니다.
- 기존에 연구하던 과제를 운영 하려는 요구사항이 있어 운영 센터에 직접 구축 하게 되었습니다.

### 추가 개발 사항
- 서비스 라우터
  - 기존 로컬 캐시로만 관리되던 선박의 정보를 DB 와 Redis 에 적재 하게 변경
    - 선박의 정보에는 IP ,PORT 등이 있음     
...
### 내용
- 인프라 구성 (Redis Sentinel, ES Clustering)
